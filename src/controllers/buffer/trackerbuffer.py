...
class TrackerBuffer:
    def __init__(self) -> None:
        ...
        self._frame: TrackPacket | None = None
        self._version = 0
        self._closed = False

    def publish(self, frame: TrackPacket) -> None:
    ...
    def wait_next(self, pre_version: int, timeout: float) -> tuple[int, TrackPacket | None]:
        with self._condition:
    ...
    def snapshot(self) -> tuple[int, TrackPacket | None]:
        with self._condition:
            return self._version, self._frame
